...
use bettermq::{EnqueueRequest, EnqueueReply, InnerMsg};
use bettermq::{DequeueRequest, DequeueReply, DataItem};
use bettermq::{AckRequest, AckReply};
use bettermq::{NackRequest, NackReply};
use super::super::storage::kv::KvStore;
use super::worker::{Worker, TaskItem};
...
impl PriorityQueueSvc {
	...
	pub fn dequeue(&self,
		...
		let reply_items = task_items.iter().filter_map( |ti| {
